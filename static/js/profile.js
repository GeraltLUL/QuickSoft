        ...
        await fetch(`${baseUrl}/get_game_sessions`)
            ...
            .then(data => {
                ...
                data.userSessionsData.forEach(gameSession => {
                    ...
                    heatMapDiv.style="background-image: url('../static/assets/img/profile/maps/map-base-image.jpg');width: 1080px;height: 1020px;border: red;border-style: double;margin: 1%;"
